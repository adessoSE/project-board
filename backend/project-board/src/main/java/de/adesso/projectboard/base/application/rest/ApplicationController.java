...
public class ApplicationController {
    ...
    @PreAuthorize("(hasPermissionToAccessUser(#userId) && hasAccessToProject(#payload.getProjectId()) && hasPermissionToApply()) || hasElevatedAccessToUser(#userId) || hasRole('admin')")
