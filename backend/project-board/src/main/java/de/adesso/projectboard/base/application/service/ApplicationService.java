...
public interface ApplicationService {
    ...
    /**
     * Marks a {@link ProjectApplication} as read by the boss.
     *
     * @param applicationId The ID of the {@link ProjectApplication} to mark.
     * @return The marked {@link ProjectApplication}.
     */
    ProjectApplication markApplicationAsRead(Long applicationId) throws ApplicationNotFoundException;
}
