...
@DataJpaTest
public class TimeAwareMessagePersistenceTest {
    ...
    public void save() {
        ...
        var relevancyDate = LocalDateTime.now();
        var subject = "Subject";
        var text = "Text";

        var expectedMessage = new TimeAwareMessage(referencedUser, addressee, subject, text, relevancyDate);
